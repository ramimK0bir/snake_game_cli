...
import os
import argparse
parser = argparse.ArgumentParser(description="ADB helper with optional --host")


parser.add_argument('--speed', type=int, default=2, help='Speed of snake')
...
"""
        ...
        await asyncio.sleep(1/speed)  # prevent blocking CPU
